...
(assert (not (or (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) (store v_ArrVal_95 0 0)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))))
