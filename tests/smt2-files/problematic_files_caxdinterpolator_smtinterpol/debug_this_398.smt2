...
(assert (let ((.cse1 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse0 (not .cse1)) (.cse4 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|))) (and (or (= v_arrayElimCell_3 v_arrayElimCell_4) .cse0) (= v_arrayElimCell_3 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (or (and (= |#memory_int| v_arrayElimArr_3) .cse0) (and .cse1 (= |#memory_int| v_arrayElimArr_2))) (= v_arrayElimArr_3 (store (store (let ((.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|))) (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse3) |ULTIMATE.start_main_~c~0#1.base| .cse4) |ULTIMATE.start_main_~a~0#1.base| .cse2)) |ULTIMATE.start_main_~b~0#1.base| .cse3) |ULTIMATE.start_main_~c~0#1.base| .cse4)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse4 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (= (select v_arrayElimCell_4 0) 0) (or .cse1 (and (= v_arrayElimCell_3 .cse3) (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse3))) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))))



(assert (not (= v_arrayElimCell_3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|))))
