...
(declare-fun v_ArrVal_95 () (Array Int Int))

(declare-fun v_ArrVal_96 () (Array Int Int))

(declare-fun v_ArrVal_93 () (Array Int Int))

(declare-fun |ULTIMATE.start_main_~a~0#1.base| () Int)

(declare-fun |#memory_int| () (Array Int (Array Int Int)))

(declare-fun |ULTIMATE.start_main_~b~0#1.base| () Int)

(declare-fun v_arrayElimCell_1 () (Array Int Int))

(declare-fun v_ArrVal_98 () (Array Int Int))

(declare-fun |ULTIMATE.start_main_~c~0#1.base| () Int)

(declare-fun v_arrayElimArr_2 () (Array Int (Array Int Int)))

(declare-fun v_arrayElimArr_1 () (Array Int (Array Int Int)))

(declare-fun v_arrayElimArr_3 () (Array Int (Array Int Int)))

(declare-fun |ULTIMATE.start_main_~c~0#1.offset| () Int)

(assert (let ((.cse5 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse6 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse0 (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|)) (.cse7 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|))) (and (= .cse0 (store v_ArrVal_98 0 0)) (let ((.cse4 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse1 (not .cse4)) (.cse2 (and .cse4 (= |#memory_int| v_arrayElimArr_2))) (.cse3 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))) (or (and (or (and (= |#memory_int| v_arrayElimArr_3) .cse1) .cse2) (not .cse3)) (and (or (and (= |#memory_int| v_arrayElimArr_1) .cse1) .cse2) .cse3)))) (= (store v_ArrVal_95 0 0) (select v_arrayElimArr_1 |ULTIMATE.start_main_~c~0#1.base|)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse5) |ULTIMATE.start_main_~b~0#1.base| .cse6) |ULTIMATE.start_main_~c~0#1.base| .cse7) |ULTIMATE.start_main_~a~0#1.base| .cse5) |ULTIMATE.start_main_~b~0#1.base| .cse6) |ULTIMATE.start_main_~c~0#1.base| .cse7)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (store (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse5) |ULTIMATE.start_main_~b~0#1.base| .cse6) |ULTIMATE.start_main_~c~0#1.base| .cse7) |ULTIMATE.start_main_~a~0#1.base| .cse5) |ULTIMATE.start_main_~b~0#1.base| .cse6) |ULTIMATE.start_main_~c~0#1.base| .cse7) v_arrayElimArr_3) (= v_arrayElimArr_2 (store (let ((.cse9 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|))) (store (let ((.cse8 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))) (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse8) |ULTIMATE.start_main_~b~0#1.base| .cse9) |ULTIMATE.start_main_~c~0#1.base| .cse0) |ULTIMATE.start_main_~a~0#1.base| .cse8)) |ULTIMATE.start_main_~b~0#1.base| .cse9)) |ULTIMATE.start_main_~c~0#1.base| .cse0)) (= .cse7 (store v_arrayElimCell_1 0 0)))))
...
(assert (or (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93) (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))



(assert (or (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|) (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) v_ArrVal_96)))



(assert (or (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|) (= v_ArrVal_96 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|))))



(assert (or (= (store v_arrayElimCell_1 0 0) (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))))



(assert (or (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) (store v_arrayElimCell_1 0 0)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))



(assert (or (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) (store v_ArrVal_95 0 0)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))



(assert (or (= (store v_ArrVal_98 0 0) (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))))



(assert (or (= (store v_ArrVal_95 0 0) (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))))



(assert (or (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|) (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|) v_ArrVal_96)))



(assert (or (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (= v_ArrVal_93 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))))



(assert (or (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_96)))



(assert (or (= v_ArrVal_96 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))



(assert (or (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_96)))



(assert (or (= (store v_ArrVal_98 0 0) (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))
...
(assert (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))

(assert (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))



(assert (not (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93)))
