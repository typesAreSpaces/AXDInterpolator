...
(assert (not (or (= (store v_ArrVal_95 0 0) (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)))))
