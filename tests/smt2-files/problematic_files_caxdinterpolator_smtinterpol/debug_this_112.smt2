...
(assert (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)))



(assert (not (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|) v_ArrVal_96)))
