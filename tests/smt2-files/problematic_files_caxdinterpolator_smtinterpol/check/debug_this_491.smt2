...
(assert (let ((.cse1 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse0 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|))) (and (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse0) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse2) |ULTIMATE.start_main_~a~0#1.base| .cse0) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse2)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (let ((.cse4 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse3 (not .cse4))) (or (and (not (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse1)) .cse3) (not (= .cse0 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))) (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (and (or .cse4 (not (= |#memory_int| v_arrayElimArr_3))) (or (not (= |#memory_int| v_arrayElimArr_2)) .cse3))))) (= (select .cse2 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0))))
