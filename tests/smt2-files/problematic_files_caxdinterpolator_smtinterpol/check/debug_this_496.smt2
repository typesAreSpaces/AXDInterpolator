...
(assert (let ((.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse1 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse0 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (.cse3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse6 (= |#memory_int| v_arrayElimArr_2))) (and .cse0 (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse2) |ULTIMATE.start_main_~c~0#1.base| .cse3) |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse2) |ULTIMATE.start_main_~c~0#1.base| .cse3)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (let ((.cse5 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse4 (not .cse5))) (or (and (not (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse2)) .cse4) (not (= .cse1 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))) .cse0 (and (or .cse5 (not (= |#memory_int| v_arrayElimArr_3))) (or (not .cse6) .cse4))))) (= (select .cse3 0) 0) .cse6 (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0))))
