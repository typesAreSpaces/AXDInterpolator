...
(assert (let ((.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse7 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse8 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse6 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (.cse9 (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|)) (.cse0 (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))) (and (or .cse0 .cse1 (= .cse2 v_ArrVal_93)) (let ((.cse5 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse3 (not .cse5)) (.cse4 (and .cse5 (= |#memory_int| v_arrayElimArr_2)))) (or (and (or (and (= |#memory_int| v_arrayElimArr_3) .cse3) .cse4) (not .cse1)) (and (or (and (= |#memory_int| v_arrayElimArr_1) .cse3) .cse4) .cse1)))) (= (select (select v_arrayElimArr_1 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (or .cse0 .cse1 (= v_ArrVal_93 .cse6)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse7) |ULTIMATE.start_main_~c~0#1.base| .cse8) |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse7) |ULTIMATE.start_main_~c~0#1.base| .cse8)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse8 0) 0) (= (select .cse9 0) 0) (= (store (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse7) |ULTIMATE.start_main_~c~0#1.base| .cse8) |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse7) |ULTIMATE.start_main_~c~0#1.base| .cse8) v_arrayElimArr_3) (= v_arrayElimArr_2 (store (let ((.cse10 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|))) (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse6) |ULTIMATE.start_main_~b~0#1.base| .cse10) |ULTIMATE.start_main_~c~0#1.base| .cse9) |ULTIMATE.start_main_~a~0#1.base| .cse6) |ULTIMATE.start_main_~b~0#1.base| .cse10)) |ULTIMATE.start_main_~c~0#1.base| .cse9)) (or .cse0 (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93) .cse1))))
