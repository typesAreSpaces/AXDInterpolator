...
(assert (not (let ((.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse1 (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))) (.cse3 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (.cse0 (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)))) (and (or (= v_arrayElimCell_3 v_arrayElimCell_4) .cse0) (or .cse1 (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) .cse2)) (or .cse1 (= v_arrayElimCell_2 v_arrayElimCell_3)) (or (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|) .cse2) .cse0) (or .cse1 (= .cse3 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))) (or (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) .cse3) .cse0)))))
