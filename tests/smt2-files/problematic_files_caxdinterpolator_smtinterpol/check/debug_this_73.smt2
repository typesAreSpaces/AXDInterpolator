...
(assert (not (let ((.cse8 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)) (.cse1 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (.cse0 (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))) (let ((.cse6 (not .cse0)) (.cse4 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (.cse9 (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|)) (.cse3 (store v_ArrVal_98 0 0)) (.cse10 (store v_ArrVal_95 0 0)) (.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse5 (not .cse1)) (.cse13 (store v_arrayElimCell_1 0 0)) (.cse11 (not .cse8)) (.cse14 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse12 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (.cse7 (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|))) (and (or .cse0 .cse1 (= .cse2 v_ArrVal_93)) (or (= .cse3 .cse4) .cse5) (or .cse1 .cse6 (= .cse2 v_ArrVal_96)) (or (= v_ArrVal_96 .cse4) .cse1 .cse6) (or .cse1 .cse6 (= .cse7 v_ArrVal_96)) (or .cse0 .cse1 (= v_ArrVal_93 .cse4)) (or .cse8 (= .cse9 v_ArrVal_96)) (or (= .cse10 .cse9) .cse11) (or (= .cse3 .cse12) .cse11) (or (= .cse7 .cse10) .cse5) (or (= .cse2 .cse13) .cse5) (or (= .cse13 .cse14) .cse11) (or .cse8 (= v_ArrVal_96 .cse14)) (or .cse8 (= .cse12 v_ArrVal_96)) (or .cse0 (= .cse7 v_ArrVal_93) .cse1))))))
