...
(assert (let ((.cse0 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (.cse5 (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~c~0#1.base|)) (.cse3 (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (.cse4 (= |ULTIMATE.start_main_~a~0#1.base| |ULTIMATE.start_main_~c~0#1.base|)) (.cse2 (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|)) (.cse9 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse8 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse10 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|))) (and (= (store (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse0) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse2) |ULTIMATE.start_main_~a~0#1.base| .cse0) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse2) v_arrayElimArr_2) (or .cse3 .cse4 (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93)) (or (= v_ArrVal_96 (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|)) .cse5) (or .cse3 (= v_ArrVal_93 .cse0) .cse4) (let ((.cse7 (not .cse5)) (.cse6 (and .cse5 (= |#memory_int| v_arrayElimArr_2)))) (or (and .cse4 (or .cse6 (and (= |#memory_int| v_arrayElimArr_1) .cse7))) (and (not .cse4) (or (and (= |#memory_int| v_arrayElimArr_3) .cse7) .cse6)))) (or (= v_ArrVal_96 .cse8) .cse5) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (or (= v_ArrVal_96 .cse1) .cse5) (or .cse3 .cse4 (= .cse9 v_ArrVal_93)) (= (select (select v_arrayElimArr_1 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (= (select .cse2 0) 0) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse9) |ULTIMATE.start_main_~b~0#1.base| .cse8) |ULTIMATE.start_main_~c~0#1.base| .cse10) |ULTIMATE.start_main_~a~0#1.base| .cse9) |ULTIMATE.start_main_~b~0#1.base| .cse8) |ULTIMATE.start_main_~c~0#1.base| .cse10)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse9) |ULTIMATE.start_main_~b~0#1.base| .cse8) |ULTIMATE.start_main_~c~0#1.base| .cse10) |ULTIMATE.start_main_~a~0#1.base| .cse9) |ULTIMATE.start_main_~b~0#1.base| .cse8) |ULTIMATE.start_main_~c~0#1.base| .cse10)))))




(assert (not (= (select (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|) 0) 0)))
