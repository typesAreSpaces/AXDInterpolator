...
(assert (or (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93)))



(assert (not (or (= (store v_ArrVal_98 0 0) (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))))
