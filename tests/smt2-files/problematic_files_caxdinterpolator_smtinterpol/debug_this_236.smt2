...
(assert (let ((.cse0 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (.cse5 (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~c~0#1.base|)) (.cse3 (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (.cse4 (= |ULTIMATE.start_main_~a~0#1.base| |ULTIMATE.start_main_~c~0#1.base|)) (.cse10 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse9 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse6 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|))) (and (= (let ((.cse2 (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|))) (store (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse0) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse2) |ULTIMATE.start_main_~a~0#1.base| .cse0) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse2)) v_arrayElimArr_2) (or .cse3 .cse4 (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93)) (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~c~0#1.base|) (store v_ArrVal_95 0 0)) (or (= v_ArrVal_96 (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|)) .cse5) (= (store v_arrayElimCell_1 0 0) .cse6) (or .cse3 (= v_ArrVal_93 .cse0) .cse4) (let ((.cse8 (not .cse5)) (.cse7 (and .cse5 (= |#memory_int| v_arrayElimArr_2)))) (or (and .cse4 (or .cse7 (and (= |#memory_int| v_arrayElimArr_1) .cse8))) (and (not .cse4) (or (and (= |#memory_int| v_arrayElimArr_3) .cse8) .cse7)))) (or (= v_ArrVal_96 .cse9) .cse5) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (or (= v_ArrVal_96 .cse1) .cse5) (or .cse3 .cse4 (= .cse10 v_ArrVal_93)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse10) |ULTIMATE.start_main_~b~0#1.base| .cse9) |ULTIMATE.start_main_~c~0#1.base| .cse6) |ULTIMATE.start_main_~a~0#1.base| .cse10) |ULTIMATE.start_main_~b~0#1.base| .cse9) |ULTIMATE.start_main_~c~0#1.base| .cse6)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse10) |ULTIMATE.start_main_~b~0#1.base| .cse9) |ULTIMATE.start_main_~c~0#1.base| .cse6) |ULTIMATE.start_main_~a~0#1.base| .cse10) |ULTIMATE.start_main_~b~0#1.base| .cse9) |ULTIMATE.start_main_~c~0#1.base| .cse6)))))




(assert (not (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0)))
