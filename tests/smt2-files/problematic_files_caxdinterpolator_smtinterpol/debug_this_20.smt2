...
(declare-fun |v_ULTIMATE.start_main_~b~0#1.base_3_const_-1559026411| () Int)

(declare-fun |v_ULTIMATE.start_main_~i~0#1_13_const_-2041037682| () Int)

(declare-fun |v_ULTIMATE.start_main_~b~0#1.offset_3_const_1626751251| () Int)
...
(assert (and (= (store |v_#memory_int_10_const_-458059215| |v_ULTIMATE.start_main_~b~0#1.base_3_const_-1559026411| (let ((.cse0 (select |v_#memory_int_10_const_-458059215| |v_ULTIMATE.start_main_~b~0#1.base_3_const_-1559026411|)) (.cse1 (* |v_ULTIMATE.start_main_~i~0#1_13_const_-2041037682| 8))) (store .cse0 (+ .cse1 |v_ULTIMATE.start_main_~b~0#1.offset_3_const_1626751251|) (+ (select .cse0 (+ .cse1 |v_ULTIMATE.start_main_~b~0#1.offset_3_const_1626751251| (- 8))) (select (select |v_#memory_int_10_const_-458059215| |v_ULTIMATE.start_main_~a~0#1.base_4_const_-1688106317|) (+ .cse1 (- 8) |v_ULTIMATE.start_main_~a~0#1.offset_4_const_2132314865|)))))) |v_#memory_int_9_const_1681331687|) (< |v_ULTIMATE.start_main_~i~0#1_13_const_-2041037682| v_~N~0_10_const_2039338620)))
