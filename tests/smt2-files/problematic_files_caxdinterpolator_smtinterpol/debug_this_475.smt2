...
(assert (let ((.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse0 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (and (or .cse0 (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse1)) (= .cse2 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse3) |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse3)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= |#memory_int| v_arrayElimArr_3) (= (select .cse3 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (or (not (= |#memory_int| v_arrayElimArr_2)) (not .cse0)))))
