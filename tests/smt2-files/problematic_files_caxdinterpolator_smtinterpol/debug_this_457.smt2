...
(assert (let ((.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse0 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|))) (and (not (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse0)) (let ((.cse1 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (or (and (= |#memory_int| v_arrayElimArr_3) (not .cse1)) (and .cse1 (= |#memory_int| v_arrayElimArr_2)))) (= .cse2 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse0) |ULTIMATE.start_main_~c~0#1.base| .cse3) |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse0) |ULTIMATE.start_main_~c~0#1.base| .cse3)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse3 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))))
