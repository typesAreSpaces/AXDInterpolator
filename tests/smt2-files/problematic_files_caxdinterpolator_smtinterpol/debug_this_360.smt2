...
(assert (and (or (= v_arrayElimCell_3 v_arrayElimCell_4) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (or (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= v_arrayElimCell_2 v_arrayElimCell_3))))
