...
(assert (or (= v_arrayElimCell_3 v_arrayElimCell_4) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))))



(assert (not (or (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)))))
