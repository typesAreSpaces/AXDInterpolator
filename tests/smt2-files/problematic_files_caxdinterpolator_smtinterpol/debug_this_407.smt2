...
(assert (let ((.cse3 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse0 (not .cse3)) (.cse2 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse5 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse4 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|))) (and (or (= v_arrayElimCell_3 v_arrayElimCell_4) .cse0) (or (not (= v_arrayElimCell_3 .cse1)) (not (= v_arrayElimCell_3 .cse2))) (or (and (= |#memory_int| v_arrayElimArr_3) .cse0) (and .cse3 (= |#memory_int| v_arrayElimArr_2))) (= .cse1 .cse2) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse4) |ULTIMATE.start_main_~c~0#1.base| .cse5) |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse4) |ULTIMATE.start_main_~c~0#1.base| .cse5)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse5 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (= (select v_arrayElimCell_4 0) 0) (or .cse3 (and (= v_arrayElimCell_3 .cse4) (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse4))) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))))
