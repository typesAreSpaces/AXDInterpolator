...
(assert (let ((.cse1 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)) (.cse4 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse6 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))) (let ((.cse3 (= .cse4 .cse6)) (.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse5 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse0 (not .cse1))) (and (or (and (= |#memory_int| v_arrayElimArr_3) .cse0) (and .cse1 (= |#memory_int| v_arrayElimArr_2))) (or (and (not (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse2)) .cse0) (not .cse3)) .cse3 (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse4) |ULTIMATE.start_main_~b~0#1.base| .cse2) |ULTIMATE.start_main_~c~0#1.base| .cse5) |ULTIMATE.start_main_~a~0#1.base| .cse4) |ULTIMATE.start_main_~b~0#1.base| .cse2) |ULTIMATE.start_main_~c~0#1.base| .cse5)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse5 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (= (select v_arrayElimCell_4 0) 0) .cse0 (or (= v_arrayElimCell_4 .cse6) .cse0) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))))
