...
(assert (not (or (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)))))
