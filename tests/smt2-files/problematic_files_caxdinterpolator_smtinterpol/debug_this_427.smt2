...
(assert (let ((.cse2 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse0 (not .cse2)) (.cse3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse4 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|))) (and (or .cse0 (= v_arrayElimCell_4 .cse1)) (or (and (= |#memory_int| v_arrayElimArr_3) .cse0) (and .cse2 (= |#memory_int| v_arrayElimArr_2))) (= .cse3 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse3) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse4) |ULTIMATE.start_main_~a~0#1.base| .cse3) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse4)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse4 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (= (select v_arrayElimCell_4 0) 0) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))))
