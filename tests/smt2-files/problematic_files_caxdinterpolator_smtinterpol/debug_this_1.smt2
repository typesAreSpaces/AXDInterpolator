...
(declare-fun |v_ULTIMATE.start_main_~c~0#1.base_1_const_-1430061064| () Int)

(declare-fun |v_ULTIMATE.start_main_~i~0#1_1_const_-342991619| () Int)

(declare-fun |v_ULTIMATE.start_main_~c~0#1.offset_1_const_1121204150| () Int)

(declare-fun |v_ULTIMATE.start_main_#t~mem17#1_1_const_484272908| () Int)
...
(assert (and (= (select (select |v_#memory_int_2_const_1681331612| |v_ULTIMATE.start_main_~c~0#1.base_1_const_-1430061064|) (+ (* |v_ULTIMATE.start_main_~i~0#1_1_const_-342991619| 8) |v_ULTIMATE.start_main_~c~0#1.offset_1_const_1121204150|)) |v_ULTIMATE.start_main_#t~mem17#1_1_const_484272908|) (< |v_ULTIMATE.start_main_~i~0#1_1_const_-342991619| v_~N~0_2_const_1589863889) (= |v_ULTIMATE.start___VERIFIER_assert_~cond#1_1_const_-1232128176| |v_ULTIMATE.start___VERIFIER_assert_#in~cond#1_1_const_-282266058|) (= (ite (= |v_ULTIMATE.start_main_#t~mem17#1_1_const_484272908| (* |v_ULTIMATE.start_main_~i~0#1_1_const_-342991619| |v_ULTIMATE.start_main_~i~0#1_1_const_-342991619|)) 1 0) |v_ULTIMATE.start___VERIFIER_assert_#in~cond#1_1_const_-282266058|)))
