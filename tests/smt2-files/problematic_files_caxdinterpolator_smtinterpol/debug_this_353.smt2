...
(assert (not (or (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|) (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)))))
