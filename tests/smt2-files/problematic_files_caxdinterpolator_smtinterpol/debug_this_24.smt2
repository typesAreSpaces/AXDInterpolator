...
(declare-fun |v_#memory_int_12_const_-458059209| () (Array Int (Array Int Int)))

(declare-fun |v_ULTIMATE.start_main_~b~0#1.base_4_const_-1559026412| () Int)

(declare-fun |v_ULTIMATE.start_main_~i~0#1_18_const_-2041037687| () Int)

(declare-fun |v_ULTIMATE.start_main_~b~0#1.offset_4_const_1626751250| () Int)

(declare-fun |v_ULTIMATE.start_main_~c~0#1.base_4_const_-1430061067| () Int)

(declare-fun |v_ULTIMATE.start_main_~c~0#1.offset_4_const_1121204147| () Int)

(declare-fun |v_#memory_int_11_const_-458059210| () (Array Int (Array Int Int)))

(declare-fun v_~N~0_12_const_2039338618 () Int)

(assert (and (< |v_ULTIMATE.start_main_~i~0#1_18_const_-2041037687| v_~N~0_12_const_2039338618) (= (store |v_#memory_int_12_const_-458059209| |v_ULTIMATE.start_main_~c~0#1.base_4_const_-1430061067| (let ((.cse0 (select |v_#memory_int_12_const_-458059209| |v_ULTIMATE.start_main_~c~0#1.base_4_const_-1430061067|)) (.cse1 (* |v_ULTIMATE.start_main_~i~0#1_18_const_-2041037687| 8))) (store .cse0 (+ |v_ULTIMATE.start_main_~c~0#1.offset_4_const_1121204147| .cse1) (+ (select (select |v_#memory_int_12_const_-458059209| |v_ULTIMATE.start_main_~b~0#1.base_4_const_-1559026412|) (+ .cse1 |v_ULTIMATE.start_main_~b~0#1.offset_4_const_1626751250| (- 8))) (select .cse0 (+ |v_ULTIMATE.start_main_~c~0#1.offset_4_const_1121204147| .cse1 (- 8))))))) |v_#memory_int_11_const_-458059210|)))
