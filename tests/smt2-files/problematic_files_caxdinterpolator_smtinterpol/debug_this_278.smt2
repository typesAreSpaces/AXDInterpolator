...
(assert (let ((.cse6 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))) (let ((.cse2 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)) (.cse0 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (.cse8 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse7 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse5 (not .cse6)) (.cse1 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (.cse9 (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|))) (and (or (and (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|) .cse0) (= .cse1 .cse0)) .cse2) (let ((.cse3 (not .cse2)) (.cse4 (and .cse2 (= |#memory_int| v_arrayElimArr_2)))) (or (and (or (and (= |#memory_int| v_arrayElimArr_3) .cse3) .cse4) .cse5) (and (or (and (= |#memory_int| v_arrayElimArr_1) .cse3) .cse4) .cse6))) (= (select (select v_arrayElimArr_1 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse7) |ULTIMATE.start_main_~b~0#1.base| .cse0) |ULTIMATE.start_main_~c~0#1.base| .cse8) |ULTIMATE.start_main_~a~0#1.base| .cse7) |ULTIMATE.start_main_~b~0#1.base| .cse0) |ULTIMATE.start_main_~c~0#1.base| .cse8)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse8 0) 0) (= (select .cse9 0) 0) (= (store (store (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse7) |ULTIMATE.start_main_~b~0#1.base| .cse0) |ULTIMATE.start_main_~c~0#1.base| .cse8) |ULTIMATE.start_main_~a~0#1.base| .cse7) |ULTIMATE.start_main_~b~0#1.base| .cse0) |ULTIMATE.start_main_~c~0#1.base| .cse8) v_arrayElimArr_3) (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) .cse7) .cse5 (= v_arrayElimArr_2 (store (store (let ((.cse10 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))) (store (store (store (store v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base| .cse10) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse9) |ULTIMATE.start_main_~a~0#1.base| .cse10)) |ULTIMATE.start_main_~b~0#1.base| .cse1) |ULTIMATE.start_main_~c~0#1.base| .cse9))))))



(assert (not (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))))
