...
(declare-fun v_arrayElimCell_3 () (Array Int Int))

(declare-fun v_arrayElimArr_2 () (Array Int (Array Int Int)))

(declare-fun v_arrayElimCell_2 () (Array Int Int))

(declare-fun v_arrayElimCell_4 () (Array Int Int))

(declare-fun v_arrayElimArr_3 () (Array Int (Array Int Int)))

(declare-fun |ULTIMATE.start_main_~c~0#1.offset| () Int)

(assert (let ((.cse2 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (.cse4 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse6 (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|)) (.cse0 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)) (.cse5 (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (.cse3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|))) (and (or (and (= |#memory_int| v_arrayElimArr_3) (not .cse0)) (and .cse0 (= |#memory_int| v_arrayElimArr_2))) (or (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (and (= v_arrayElimCell_2 .cse1) (= v_arrayElimCell_2 .cse2))) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse3) |ULTIMATE.start_main_~c~0#1.base| .cse4) |ULTIMATE.start_main_~a~0#1.base| .cse2) |ULTIMATE.start_main_~b~0#1.base| .cse3) |ULTIMATE.start_main_~c~0#1.base| .cse4)) (= v_arrayElimArr_2 (store (store (store (store (store (store (store (store (store (store (store (store v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse5) |ULTIMATE.start_main_~c~0#1.base| .cse6) |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse5) |ULTIMATE.start_main_~c~0#1.base| .cse6) |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse5) |ULTIMATE.start_main_~c~0#1.base| .cse6) |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse5) |ULTIMATE.start_main_~c~0#1.base| .cse6)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse4 0) 0) (= (select .cse6 0) 0) (= (select v_arrayElimCell_4 0) 0) (or .cse0 (and (= v_arrayElimCell_3 .cse3) (= .cse5 .cse3))) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))))
...
(assert (or (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))))



(assert (or (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))))



(assert (or (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|) (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))))



(assert (or (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= v_arrayElimCell_2 v_arrayElimCell_3)))



(assert (or (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|))))
...
(assert (not (= v_arrayElimCell_3 v_arrayElimCell_4)))
