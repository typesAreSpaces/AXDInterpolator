...
(assert (let ((.cse2 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)) (.cse0 (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (.cse1 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))) (and (or .cse0 .cse1 (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93)) (or .cse0 .cse1 (= v_ArrVal_93 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))) (or .cse2 (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~b~0#1.base|) v_ArrVal_96)) (or .cse2 (= v_ArrVal_96 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|))) (or .cse2 (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) v_ArrVal_96)) (or .cse0 (= (select v_arrayElimArr_1 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_93) .cse1))))
