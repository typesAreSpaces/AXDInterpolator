...
(assert (let ((.cse2 (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|))) (let ((.cse0 (not .cse2)) (.cse1 (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|)) (.cse4 (select v_arrayElimArr_3 |ULTIMATE.start_main_~c~0#1.base|)) (.cse3 (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|))) (and (or (= v_arrayElimCell_3 v_arrayElimCell_4) .cse0) (or (not (= v_arrayElimCell_3 .cse1)) (not (= v_arrayElimCell_3 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)))) (or (and (= |#memory_int| v_arrayElimArr_3) .cse0) (and .cse2 (= |#memory_int| v_arrayElimArr_2))) (= v_arrayElimArr_3 (store (store (store (store (store (store v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse3) |ULTIMATE.start_main_~c~0#1.base| .cse4) |ULTIMATE.start_main_~a~0#1.base| .cse1) |ULTIMATE.start_main_~b~0#1.base| .cse3) |ULTIMATE.start_main_~c~0#1.base| .cse4)) (= |ULTIMATE.start_main_~c~0#1.offset| 0) (= (select .cse4 0) 0) (= (select (select v_arrayElimArr_2 |ULTIMATE.start_main_~c~0#1.base|) 0) 0) (= (select v_arrayElimCell_4 0) 0) (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (or .cse2 (and (= v_arrayElimCell_3 .cse3) (= (select v_arrayElimArr_2 |ULTIMATE.start_main_~b~0#1.base|) .cse3))) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|))))))



(assert (not (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|))))
