...
(assert (not (or (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)) (= (select v_arrayElimArr_3 |ULTIMATE.start_main_~a~0#1.base|) v_ArrVal_96))))
