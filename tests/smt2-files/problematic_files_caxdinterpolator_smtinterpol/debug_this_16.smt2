...
(assert (and (< |v_ULTIMATE.start_main_~i~0#1_8_const_-342991626| v_~N~0_8_const_1589863915) (= (store |v_#memory_int_8_const_1681331686| |v_ULTIMATE.start_main_~a~0#1.base_3_const_-1688106316| (let ((.cse0 (select |v_#memory_int_8_const_1681331686| |v_ULTIMATE.start_main_~a~0#1.base_3_const_-1688106316|)) (.cse1 (* |v_ULTIMATE.start_main_~i~0#1_8_const_-342991626| 8))) (store .cse0 (+ .cse1 |v_ULTIMATE.start_main_~a~0#1.offset_3_const_2132314866|) (+ 6 (select .cse0 (+ .cse1 (- 8) |v_ULTIMATE.start_main_~a~0#1.offset_3_const_2132314866|)))))) |v_#memory_int_7_const_1681331681|)))
