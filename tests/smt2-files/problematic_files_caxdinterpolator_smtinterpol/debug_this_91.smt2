...
(assert (not (or (= v_ArrVal_96 (select v_arrayElimArr_2 |ULTIMATE.start_main_~a~0#1.base|)) (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~a~0#1.base|) (not (= |ULTIMATE.start_main_~b~0#1.base| |ULTIMATE.start_main_~a~0#1.base|)))))
