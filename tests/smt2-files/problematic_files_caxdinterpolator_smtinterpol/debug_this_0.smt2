...
(declare-fun |v_#memory_int_1_const_1681331615| () (Array Int (Array Int Int)))

(declare-fun |v_#valid_1_const_-218547636| () (Array Int Int))

(declare-fun |v_#StackHeapBarrier_1_const_531197024| () Int)

(declare-fun |v_#NULL.base_1_const_797218431| () Int)

(declare-fun v_~N~0_1_const_1589863890 () Int)

(declare-fun |v_#length_1_const_324636458| () (Array Int Int))

(declare-fun |v_#NULL.offset_1_const_-1647097731| () Int)

(assert (let ((.cse0 (select |v_#memory_int_1_const_1681331615| 1))) (and (= 48 (select .cse0 0)) (= (select |v_#valid_1_const_-218547636| 2) 1) (= (select |v_#valid_1_const_-218547636| 0) 0) (< 0 |v_#StackHeapBarrier_1_const_531197024|) (= |v_#NULL.base_1_const_797218431| 0) (= 1 (select |v_#valid_1_const_-218547636| 3)) (= v_~N~0_1_const_1589863890 0) (= (select |v_#length_1_const_324636458| 2) 9) (= (select |v_#length_1_const_324636458| 3) 12) (= (select |v_#valid_1_const_-218547636| 1) 1) (= 2 (select |v_#length_1_const_324636458| 1)) (= (select .cse0 1) 0) (= |v_#NULL.offset_1_const_-1647097731| 0))))
