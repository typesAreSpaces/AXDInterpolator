...
(assert (not (or (= (store v_arrayElimCell_1 0 0) (select v_arrayElimArr_3 |ULTIMATE.start_main_~b~0#1.base|)) (not (= |ULTIMATE.start_main_~c~0#1.base| |ULTIMATE.start_main_~b~0#1.base|)))))
