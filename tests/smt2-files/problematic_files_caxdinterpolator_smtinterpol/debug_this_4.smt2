...
(declare-fun |v_ULTIMATE.start_main_#res#1_2_const_-1281197124| () Int)

(declare-fun v_~N~0_4_const_1589863919 () Int)

(assert (and (= |v_ULTIMATE.start_main_#res#1_2_const_-1281197124| 1) (<= v_~N~0_4_const_1589863919 0)))
