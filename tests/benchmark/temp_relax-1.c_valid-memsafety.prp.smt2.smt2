...
(declare-fun v_is_relaxed_prefix_~i~0_2_const_1442013102 () Int)
(declare-fun v_is_relaxed_prefix_~i~0_1_const_1442013103 () Int)
(assert (let ((v_is_relaxed_prefix_~i~0_2 v_is_relaxed_prefix_~i~0_2_const_1442013102) (v_is_relaxed_prefix_~i~0_1 v_is_relaxed_prefix_~i~0_1_const_1442013103)) (= (+ v_is_relaxed_prefix_~i~0_2 1) v_is_relaxed_prefix_~i~0_1)))
(check-sat)
