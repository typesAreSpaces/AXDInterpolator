...
axdinterpolator::StandardInput::WriteVector::WriteVector() : 
  m_vector({}) {}

// Keeps track of the a, b, index in 
// wr-equations of the form a = wr(b, index, e)
void axdinterpolator::StandardInput::WriteVector::add(
    z3::expr const & a, 
    z3::expr const & b, 
    z3::expr const & index,
...
operator<<(std::ostream &os,
	   axdinterpolator::StandardInput::WriteVector const &wv) {
